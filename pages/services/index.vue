    ...
    <div class="py-6 mx-auto">
      ...
      >
        <div class="bg-[#ffffffb3] p-10 px-4 tablet:px-10">
          ...
          <div
            class="mb-8 text-sm font-normal text-justify aos-init aos-animate"
            data-aos="fade-up"
          >
      ...
      <div
        class="flex flex-row flex-wrap gap-6 p-10 px-4 tablet:px-10 md:flex-col"
      >
        <div
          class="flex flex-col w-full overflow-hidden shadow-md md:flex-row services-card"
          data-aos="fade-down"
