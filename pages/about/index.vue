...
<template>
  <section id="about">
    <div
      class="title"
      :style="`background-image: url('${config.public.apiPublic}/images/static/${staticData?.data?.about_hero_image}')`"
    >
      <div class="bg-[#ffffffb3] px-10 py-10">
        <h1
          class="pb-2 my-4 text-4xl font-bold capitalize border-b-4 text-main w-fit border-main"
          data-aos="fade-up"
        >
        ...
        <div
          ...
          data-aos="fade-up"
          v-html="staticData?.data?.about_section1_info"
        ></div>
      </div>
    </div>
    <div class="px-10 pb-6 mx-auto text-xs leading-5">
      <div class="block my-6">
        ...
        <div class="flex flex-wrap gap-6">
          ...
          >
            ...
            <div
              class="no-tailwind"
              v-html="staticData?.data?.about_vision_content"
            ></div>
          </div>
          <div
            class="bg-main text-white p-6 w-[40%] grow min-w-[300px]"
          ...
          >
            ...
            <div
              v-html="staticData?.data?.about_misi_content"
              class="no-tailwind"
            ></div>
          </div>
        </div>
      ...
      <div class="flex flex-wrap gap-6">
        <div
          ...
          data-aos="fade-up"
          v-html="staticData?.data?.about_history_content"
        ></div>
        <div
          class="max-h-[300px] md:order-1 order-1 w-[40%] grow min-w-[200px]"
        >
          <img
        ...
        <div class="md:order-4 order-4 w-[40%] grow min-w-[200px]">
          <img
            ...
            class="object-cover w-full h-full"
            height="400"
            :src="`${config.public.apiPublic}/images/static/${staticData?.data?.about_range_image}`"
            width="600"
            data-aos="fade-up"
          />
        </div>
        <div
          ...
          data-aos="fade-up"
          v-html="staticData?.data?.about_range_content"
        ></div>
      </div>
    </div>
  </section>
