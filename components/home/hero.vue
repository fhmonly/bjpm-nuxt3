<template>
    <section id="home" class="relative flex flex-col items-center h-[87vh]">
        <swiper-container speed="500" autoplay-delay="4000" class="z-0 w-full h-full">
            <swiper-slide>
                <img :src="'/img/hero/1.jpg'" alt="" class="object-cover w-full h-full">
            </swiper-slide>
            <swiper-slide>
                <img :src="'/img/hero/2.jpg'" alt="" class="object-cover w-full h-full">
            </swiper-slide>
            <swiper-slide>
                <img :src="'/img/hero/3.jpg'" alt="" class="object-cover w-full h-full">
            </swiper-slide>
            <swiper-slide>
                <img :src="'/img/hero/4.jpg'" alt="" class="object-cover w-full h-full">
            </swiper-slide>
            <swiper-slide>
                <img :src="'/img/hero/5.jpg'" alt="" class="object-cover w-full h-full">
            </swiper-slide>
        </swiper-container>
            ...
            <div class="caption-wrapper flex bg-[#438D3DB2] text-white h-full items-center justify-between p-5 md:p-10">
                <div class="caption-detail grow max-w-[728px] ">
                    ...
                    <p class="text-[14px] my-3 mb-6 sm:me-10">
                        <i>
                            “Supplier, Industries, Scaffolding, Beton Lift, Concrete Bucket, Belt Conveyor,
                            Steel Construction, Asphal Sprayer, Stone Crusher “
                        </i>
                    </p>
